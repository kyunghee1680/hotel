...
func KafkaConsumer(){
    ...
    for {
        ...
        if err == nil {
            ...
            if dat["eventType"] == "HotelReservationCanceled"{
                wheneverHotelReservationCanceled_IncreaseRoom(dat)
            }
            if dat["eventType"] == "HotelReservationCompleted"{
                wheneverHotelReservationCompleted_DecreaseRoom(dat)
            }
